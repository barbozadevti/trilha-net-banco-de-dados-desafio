-- Carga inicial do Claquete (gerada a partir de database/sqlserver/01-criar-banco.sql)
-- A ordem dos INSERTs segue o script original (elenco antes dos filmes); as chaves
-- estrangeiras são verificadas só no COMMIT.
